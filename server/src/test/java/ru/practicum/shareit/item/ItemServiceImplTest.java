...
class ItemServiceImplTest {
    ...
    void getAllItemsUser() {
        List<ItemDtoBooking> itemDtoBookings = (List<ItemDtoBooking>) itemService.getAllItemsUser(ownerItem2.getId(),
                0, 10);
    ...
    void searchItemsEmpty() {
        Collection<ItemDto> itemDtos = itemService.searchItems("", 0, 10);
    ...
    void searchItems() {
        List<ItemDto> itemDtos = (List<ItemDto>) itemService.searchItems("tem", 0, 10);
